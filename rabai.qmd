...
## Lenga
```{r}
#| label: lenga-malaria-tests
#| echo: false
#| warning: false
#| fig-width: 12
#| fig-height: 6
#| 
fxn_compare_MOH705A(moh705A_long_compare, "Lenga")
```

## Makanzani
```{r}
#| label: makanzani-malaria-tests
#| echo: false
#| warning: false
#| fig-width: 12
#| fig-height: 6
#| 
fxn_compare_MOH705A(moh705A_long_compare, "Makanzani")
```
